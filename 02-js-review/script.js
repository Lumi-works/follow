...
in ${getYear(publicationDate)}. The book has ${
  hasMovieAdaptation ? "" : "not"
} been adapted as a movie `;
summary;

const pagesRange = pages > 1000 ? "over a thouhsand" : "less than 1000";
pagesRange;
...
// // return the second value only when the first value is null or undefined
...
// 3) updata a book object in an array
